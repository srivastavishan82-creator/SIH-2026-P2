...
function Analytics() {
  ...
  const kpis = [
    ...
    { title: 'Accuracy F1', value: '94.8 percent', delta: '2.1 percent', color: '#000000', deltaBg: '#d9f203' },
  ];
  ...
  return (
    <div className="animate-fade-in-up analytics-section" style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', gap: 16, flexWrap: 'wrap', alignItems: 'center' }}>
          <div style={{ flex: '1 1 320px', minWidth: 280 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap' }}>
              <Tag style={{ margin: 0, background: '#d9f203', color: '#000000', border: '1px solid #000000', borderRadius: 999, fontWeight: 800, fontSize: 11, padding: '4px 10px', lineHeight: 1 }}>ANALYTICS LIVE</Tag>
            ...
            <div style={{ color: '#000000', fontSize: 13, marginTop: 6, lineHeight: 1.5 }}>Operational performance, throughput metrics, and district ledger reports.</div>
          </div>
          <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', alignItems: 'center', flexShrink: 0 }}>
            ...
            <Tag style={{ margin: 0, borderRadius: 999, background: '#d9f203', color: '#000000', border: '1px solid #000000', fontWeight: 800, padding: '5px 12px', fontSize: 11, lineHeight: 1 }}>F1 94.8 percent</Tag>
          </div>
        </div>
      </Card>
      ...
      <Row gutter={[12, 12]} style={{ alignItems: 'stretch' }}>
        {kpis.map(k => (
          <Col xs={12} lg={6} key={k.title} style={{ display: 'flex' }}>
            <Card bordered={false} bodyStyle={{ padding: '16px 18px', display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: 6 }} style={{ background: '#ffffff', border: '2px solid #000000', borderRadius: 14, flex: 1, display: 'flex', flexDirection: 'column', boxShadow: '0 4px 12px rgba(0,0,0,0.06)' }}>
      ...
      <Row gutter={[12, 12]} style={{ display: 'flex', alignItems: 'stretch' }}>
          ...
          <Card title={<span style={{ fontWeight: 850, color: '#000000', fontSize: 15 }}>Throughput and Accuracy</span>} extra={<Tag style={{ margin: 0, borderRadius: 999, background: '#ffffff', border: '1px solid #000000', color: '#000000', fontWeight: 700, fontSize: 11, padding: '4px 10px' }}>docs per day</Tag>} bordered={false} bodyStyle={{ padding: '16px', display: 'flex', flexDirection: 'column', gap: 14 }} style={{ background: '#ffffff', border: '2px solid #000000', borderRadius: 14, flex: 1, display: 'flex', flexDirection: 'column', boxShadow: '0 4px 12px rgba(0,0,0,0.06)' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 12, flexWrap: 'wrap', fontSize: 12, color: '#000000', background: '#ffffff', padding: '10px 14px', borderRadius: 8, border: '1px solid #000000' }}>
                ...
                <span style={{ color: '#000000', fontWeight: 800, background: '#d9f203', border: '1px solid #000000', borderRadius: 999, padding: '3px 8px', fontSize: 11 }}>Peak Surge Sat 110</span>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              {accuracyData.map(a => (
                <div key={a.name} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12, background: '#ffffff', border: '1px solid #000000', borderLeft: `5px solid ${a.fill === '#d9f203' ? '#d9f203' : '#000000'}`, borderRadius: 10, padding: '14px 16px' }}>
                  ...
                  <div style={{ textAlign: 'right', flexShrink: 0 }}>
                    ...
                    <div style={{ fontSize: 11, color: '#000000', marginTop: 2, lineHeight: 1, fontWeight: 600 }}>{a.value === 65 ? '268 auto verified' : a.value === 25 ? '103 routed to audit' : '42 retry'}</div>
                  </div>
                </div>
              ))}
            </div>
        ...
        <Col xs={24} lg={12} style={{ display: 'flex' }}>
          <Card title={<div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12, flexWrap: 'wrap' }}><span style={{ fontWeight: 850, color: '#000000', fontSize: 15 }}>District Ledger</span><span style={{ fontSize: 11, fontWeight: 700, color: '#000000', background: '#d9f203', border: '1px solid #000000', borderRadius: 999, padding: '4px 8px', lineHeight: 1 }}>{totalProcessed} verified {totalPending} pending</span></div>} bordered={false} bodyStyle={{ padding: '16px', display: 'flex', flexDirection: 'column', gap: 12 }} style={{ background: '#ffffff', border: '2px solid #000000', borderRadius: 14, flex: 1, display: 'flex', flexDirection: 'column', boxShadow: '0 4px 12px rgba(0,0,0,0.06)' }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              {districtData.map(d => {
                const pct = Math.round(d.processed / d.total * 100);
                const isHigh = pct >= 85;
                return (
                  <div key={d.name} style={{ display: 'grid', gridTemplateColumns: '1fr auto', gap: 12, alignItems: 'center', background: isHigh ? '#ffffff' : '#ffffff', border: `1px solid #000000`, borderLeft: isHigh ? '5px solid #d9f203' : '5px solid #000000', borderRadius: 10, padding: '12px 14px' }}>
                    <div style={{ minWidth: 0 }}>
                      ...
                      <div style={{ fontSize: 11, color: '#000000', marginTop: 6, lineHeight: 1, fontWeight: 600 }}>VERIFIED</div>
                    </div>
                    <div style={{ textAlign: 'right', flexShrink: 0 }}>
            ...
            <div style={{ marginTop: 'auto', background: '#000000', border: '2px solid #000000', borderRadius: 12, padding: '14px 16px', color: '#ffffff', display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 12, flexWrap: 'wrap' }}>
              <div>
              ...
              <Tag style={{ margin: 0, background: '#d9f203', color: '#000000', border: '1px solid #d9f203', borderRadius: 999, fontWeight: 800, fontSize: 10, padding: '4px 8px', lineHeight: 1 }}>MAP PREVIEW</Tag>
            </div>
          </Card>
        </Col>
      </Row>
